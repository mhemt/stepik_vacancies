...
from vacancies.views import MainView, VacanciesView, CompanyView, MyLoginView, MyCompanyView, MyCompanyCreateView, \
    MyCompanyVacanciesView, MyCompanyVacancyCreateView, MyCompanyVacancyEdit, MyResumeView, MyResumeCreateView, \
    RegisterView, SearchView, VacancyView, ApplicationSentView, custom_handler404, custom_handler500
